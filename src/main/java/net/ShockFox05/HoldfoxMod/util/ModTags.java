...
public class ModTags {
    public static class Blocks {
        public static final TagKey<Block> NEEDS_FOX_TOOL = createTag("needs_fox_tool");
        public static final TagKey<Block> INCORRECT_FOR_FOX_TOOL = createTag("incorrect_for_fox_tool");
